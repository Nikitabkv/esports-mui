...
const theme = createTheme({
  ...
  shadows: [
    "none", // 0
    "48px 0px 5px -46px rgba(0, 0, 0, 0.05) inset, -48px 0px 5px -46px rgba(0, 0, 0, 0.05) inset, 0px -48px 5px -46px rgba(0, 0, 0, 0.05) inset, 0px 48px 5px -46px rgba(0, 0, 0, 0.05) inset",// 1
    ...
    "0px -48px 3px -46px rgba(0, 0, 0, 0.05) inset",// 4 // AppBar // Header
    "0px 48px 3px -46px rgba(0, 0, 0, 0.05) inset",// 5 // Footer // Like header reverse
